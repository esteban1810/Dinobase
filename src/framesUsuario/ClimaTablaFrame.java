 ...
 * @author Cesar
 */
public class ClimaTablaFrame extends javax.swing.JFrame {

    /**
     * Creates new form ClimaTablaFrame
     */
    public ClimaTablaFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClimaTablaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClimaTablaFrame().setVisible(true);
            }
        });
    }
