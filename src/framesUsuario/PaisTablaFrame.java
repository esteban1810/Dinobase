 ...
 * @author Cesar
 */
public class PaisTablaFrame extends javax.swing.JFrame {

    /**
     * Creates new form PaisTablaFrame
     */
    public PaisTablaFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaisTablaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaisTablaFrame().setVisible(true);
            }
        });
    }
