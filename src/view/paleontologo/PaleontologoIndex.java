 ...
 * @author franc
 */
public class PaleontologoIndex extends javax.swing.JFrame {

    /**
     * Creates new form TiempoFrame
     */
    public PaleontologoIndex() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaleontologoIndex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaleontologoIndex().setVisible(true);
            }
        });
    }
